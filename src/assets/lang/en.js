module.exports = {
    ...
    otc:{
        ...
        tradeinfo:{
          ...
          limitMax:'Cannot exceed the maximum amount',
        ...
        identBusiness:{
            ...
            advantage:'Become DBEX certified merchants, enjoy more trading privileges',
            ...
            content1:'Become DBEX certified merchant,Enjoy more trading privileges',
    ...
    cms:{
      ...
      exchangeruleList:{
        fbbuyrule:{
          title:' Fiat Trading Area – Notice to Buyers',
          rule1:'.Identify your account before joining fiat trading area. ',
          rule2:'.If the buyer cancels the order or the order is canceled due to timeout, the buyer will get one cancellation record.',
          rule3:'.After 3 canceled orders, the buying function will be restricted for 24 hours. ',
          rule4:'.If the buying function is restricted due to seller did not provide a valid payment method, buyer is allowed to contact official CS for unblock. ',
          rule5:'.DO NOT CLICK “I’ve paid” if payment is uncompleted, system can consider it as a malicious act. In case of any appeals towards malicious confirmation of payment, the seller can refuse the transaction. If the circumstances are grave, system will freeze the buyer’s account. ',
          rule6:'.Please complete payment by using your own beneficiary account. If you use others’ beneficiary account for payment, the seller is entitled to cancel the transaction after the refund.  ',
          rule7:'.In order to complete the transaction timely, real-time payment, such as Alipay, Wechat Pay, or instant banking transfer is suggested since there will be a quick arrival. The payment exceeding 50,000 CNY should be paid in batches to ensure the timely payment from 5PM to next day 9AM. ',
          rule8:`.Digital assets corresponding to pending orders will be locked, waiting for buyer's payment and then seller's release. If no digital assets are received after the buyer pays the order and clicks “I’ve paid” for 30 minutes, the buyer can click “Appeal” at once and our CS support will intervene to judge this appeal case. The buyer will get the owner right of the assets after confirming all the above information.`,
          rule9:`.The buyer can still cancel the transaction after the cancellation of the transaction, the platform is not responsible for the buyer's paid assets, the buyer must coordinate with the seller for refund.`,
          notice:'Tips: Please note 8 digits random payment reference number in the remark section during payment transfer. To prevent the occurrence of delaying payment, buyers shall not write down the words such as BTC, Coins, or digital assets. '
        },
        fbsellrule:{
          title:' Fiat Trading Area – Notice to Sellers',
          rule1:'.Please double check you want to sell digital assets at the selling price after setting it. Should there be any appeals arising from price issues, we will judge that the buyer has the owner right of the assets and then transfer them to the buyer.',
          rule2:'.If no payment is received after the buyer clicks “I’ve paid”, the buyer can click “Appeal” for further processing at any time. If the buyer does not follow the right procedure, the seller is entitled to cancel or apply appeal this transaction after the buyer clicks “I’ve paid” for 30 minutes.  ',
          rule3:'.Please make sure the buyers’ beneficiary account is consistent with the verified payment account. If not, the seller should pay attention to the risk of receiving the payment. When such orders are appealed, the seller can choose to refuse the transaction with a refund.',
          rule4:'Please release the coin as soon as the online banking receipt is confirmed. In the following appeal case, DBEX will release coin to buyers and freeze sellers’ account: the buyer did not violate any regulations; the seller did not release the coin after the buyer has clicked “I have paid”; the buyer has the right to request for refund but the seller rejects coordinate.  ',
          rule5:'.In order to complete the transaction timely, make sure that you can handle orders timely before posting ads. Or you can hide your ad to avoid unnecessary disputes if you cannot ensure enough online time.',
          notice:'Note: for trading disputes, the platform has the final judgment right. The platform may choose to freeze accounts for acts such as the malicious freezing of orders, the malicious payment, and the use of transactions suspected of fraud, etc., and assist the judicial authorities when necessary.'
        },
        adrule:{
          title:'Advertising rules:',
          rule1:'.Become an advertiser, one must meet the conditions of the certified trades, the traders must get approved for advertisement application.',
          rule2:'.Traders who advertise, need to complete identity verification first, and complete bank card/Alipay/WeChat binding.',
          rule3:'.In order to ensure the normal operation of the transaction, the traders who advertises needs to ensure that there are minimum0.1BTC or 1ETH or 100USDT in the account.',
          rule4:'.After the transaction is completed, 0.5% of the advertiser’s transaction amount will be charged as the transaction fee.',
          rule5:`.If you are not at the side of the device or offline and can't process the order in time, please drop the advertisement in advance. If such an advertisement generates an order, it will be considered as a normal order and will be processed according to the normal transaction process.`,
          rule6:'.The system will limit the number of buying on the same day if 3 orders are canceled in total on the same day.',
          rule7:`.Advertisers sell digital asset and buyers select this form for trading. However, the last order status is the cancellation of the order. The digital asset will not be returned to the selling advertisement order and will be directly returned to the advertiser's wallet.`,
          rule8:'.When the advertisement is published, the transaction deadline must be set. The transaction deadline is the specified effective payment time limit; for example, if the buyer publishes a USDT order and sets a transaction period of 15 minutes, then the effective time is 15 minutes. If the buyer put a buying order and sets the transaction period to 15 minutes, the time limit of payment is 15 minutes.',
          notice:'All the rules and regulations are subject to change as per actual operations. Please keep following on any update if have.',
        }     
      },
      feeNoteList:{
        fbfee:{
    ...
    description: {
        ...
        message3: 'DBEX Exchange supports 100,000 transactions per second, giving users a hearty transaction experience',
        message4: 'Multi-terminal APP, easily traded between',
        message5: 'DBEX Exchange DBEX Mobile Office Mobile Client Focused on Handheld Trading Experience',
        message6:'Authoritative trading platform',
        message7:'Block chain project',
        message8:'Fast and convenient',
        iphone:'Iphone download',
        andriod:'andriod download'
    },
    footer: {
