            ...
            <div class="bill_box rightarea padding-right-clear record">
                <div class="col-xs-12 rightarea-con">
                    <div class="form-group">
                        ...
                        <Button type="primary" @click="queryOrder(0)" style="padding: 6px 50px;margin-left:10px;">{{$t('uc.finance.record.search')}}</Button>
                    </div>
    ...
    methods: {
        ...
        queryOrder(index){
            ...
            if (this.rangeDate.length == 0) {
                 this.$Message.error(this.$t('uc.finance.searchTime'));
                return;
            }else {
                try {
