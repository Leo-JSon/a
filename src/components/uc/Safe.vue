                ...
                <section class="accountContent">
                    <div class="account-in">
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                <Icon type="card" style="font-size: 18px;color: #9F9686;"></Icon>
                                <span class="card-number">{{$t('uc.safe.verified')}}</span>
                                <p v-if="user.realVerified==1" class="bankInfo" style="color: #9F9686;">{{user.realName}}</p>
                                <p v-else class="bankInfo" style="color: #9F9686;">
                                    ...
                                    <Form ref="formValidate6" :model="formValidate6" :rules="ruleValidate" :label-width="85">
                                        ...
                                        <div style="height:350px;">
                                            <Col span="8">
                                                ...
                                                <img id="frontCardImg" style="width: 270px;height: 175px;" :src="lang =='English'? frontCardImg_en:frontCardImg">
                                                <div class="acc_sc">
                                            ...
                                            <Col span="8">
                                                ...
                                                <img id="backCardImg" style="width: 270px;height: 175px;" :src="lang=='English'?backCardImg_en:backCardImg">
                                                <div class="acc_sc">
                                            ...
                                            <Col span="8">
                                                ...
                                                <img id="handCardImg" style="width: 270px;height: 175px;" :src="lang=='English'? handCardImg_en : handCardImg">
                                                <div class="acc_sc">
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                <Icon type="email" style="font-size: 18px;color: #9F9686;"></Icon>
                                <span class="card-number">{{$t('uc.safe.email')}}</span>
                                <p v-if="user.emailVerified==1" class="bankInfo" style="color: #9F9686;">
                                    {{user.email}}
                                </p>
                                <p v-else class="bankInfo" style="color: #9F9686;">
                                  {{$t('uc.safe.bindemail')}}
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                <Icon type="ios-telephone" style="font-size: 18px;color: #9F9686;"></Icon>
                                <span class="card-number">{{$t('uc.safe.phone')}}</span>
                                <p v-if="user.phoneVerified==1" class="bankInfo" style="color: #9F9686;">
                                    {{user.mobilePhone}}
                                </p>
                                <p v-else class="bankInfo" style="color: #9F9686;">
                                  {{$t('uc.safe.bindphone')}}
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                <Icon type="locked" style="font-size: 18px;color: #9F9686;"></Icon>
                                <span class="card-number">{{$t('uc.safe.loginpwd')}}</span>
                                <p class="bankInfo" style="color: #9F9686;">
                                  {{$t('uc.safe.logintip')}}
                                </p>
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                <Icon type="lock-combination" style="font-size: 18px;color: #9F9686;"></Icon>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            frontCardImg_en:require('../../assets/images/frontCardImg_en.png'),
            backCardImg_en:require('../../assets/images/backCardImg_en.png'),
            handCardImg_en:require('../../assets/images/HandCardImg_en.png'),
