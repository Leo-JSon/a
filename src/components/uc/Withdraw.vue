                    ...
                    <div class="table-inner action-box">
                            ...
                            <div class="inner-box">
                                <div class="form-group form-address">
                                    ...
                                    <div class="control-input-group">
                                        <Select v-model="withdrawAdress" :placeholder="$t('common.pleaseSelect')" ref='selectStore' clearable>
                        ...
                        <div class="form-group-container">
                            <div class="form-group form-amount">
                                ...
                                <div class="input-group content100" style='width:100%;'>
                                    <Poptip trigger="focus" :content="$t('uc.finance.withdraw.tip1')+currentCoin.withdrawScale+$t('uc.finance.withdraw.tip11')+currentCoin.minAmount+' ,'+$t('uc.finance.withdraw.tip2')+currentCoin.maxAmount" style="width:100%;">
                                        <InputNumber @on-change="computerAmount" :precision="currentCoin.withdrawScale" v-model="withdrawAmount" :placeholder="$t('uc.finance.withdraw.numtip1')" size="large" style="width:100%;" ></InputNumber>
        ...
        getMember() {
          ...
          this.$http.post(this.host + '/uc/approve/security/setting').then(response => {
            ...
            if (resp.code == 0) {
                ...
                } else if (resp.data.phoneVerified != 1) {
                    this.$Message.info(this.$t('uc.safe.submittip2'));
                    self.$router.push('/uc/safe');
