        ...
        <ul>
          ...
          <li>
            ...
            <ul class="indent">
              ...
              <li>1.6 This Agreement is only binding on the rights and obligations between you and us, and does not involve legal relations and legal disputes arising from and relating to the transaction of digital assets between the users of this Website, and between other websites and you.</li>
            </ul>
          </li>
        </ul>
...
<style scoped>
  ...
  .agreement_tab a.cur {
    color: #D58C2A;
    font-weight: bold;
    border-bottom: 2px solid #D58C2A;
  }
