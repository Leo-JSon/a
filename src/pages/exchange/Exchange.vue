    ...
    <div class="container exchange">
                        ...
                        <div class="trade_panel trade_panel_logout">
                            ...
                            <div class="trade_bd">
                                <div class="panel panel_buy">
                                    ...
                                    <div class="bd bd_limited" v-show="!showMarket">
                                        <Form ref="formValidate">
                                            <p style="font-size:10px;color:#37F081;">
                                                {{$t("exchange.buyprice")}}
                                            </p>
                                            <FormItem>
                                            ...
                                            <Button @click="buyWithLimitPrice" v-show="isLogin" style='background-color:#37F081'>{{$t("exchange.buyin")}}{{currentCoin.coin}}</Button>
                                        </Form>
                                    </div>
                                    <div class="bd bd_market" v-show="showMarket">
                                        <Form ref="formValidate">
                                            ...
                                            <Button @click="buyWithMarketPrice" v-show="isLogin" style='background-color:#37F081'>{{$t("exchange.buyin")}}{{currentCoin.coin}}</Button>
                                        </Form>
                                    </div>
                                </div>
                                <div class="panel panel_sell">
                                    ...
                                    <div class="bd bd_limited" v-show="!showMarket">
                                        <Form ref="formValidate">
                                            <p style="font-size:10px;color:#F35339;">
                                            ...
                                            <Button @click="sellLimitPrice" v-show="isLogin" style='background-color:#F35339;'>{{$t("exchange.sellout")}}{{currentCoin.coin}}</Button>
                                        </Form>
                                    </div>
                                    <div class="bd bd_market" v-show="showMarket">
                                        <Form ref="formValidate">
                                            ...
                                            <!--<Slider v-model="value6" :step="25" show-stops min="0" max="100"></Slider>-->
                                            <!--</FormItem>-->
                                            <Button @click="sellMarketPrice" v-show="isLogin" style='background-color:#F35339;'>{{$t("exchange.sellout")}}{{currentCoin.coin}}</Button>
                                        </Form>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="open_orders" v-show="isLogin">
            ...
            <!-- <Tabs>
                ...
                <TabPane > -->
                    <Table  :columns="currentOrder.columns" :data="currentOrder.rows" :no-data-text="$t('common.nodata')" class='hasWhiteBtn'></Table>
                <!-- </TabPane>
        ...
        getKline(){
            ...
            require(["@js/charting_library/charting_library.min.js"],function(tv){
                var widget = window.tvWidget = new TradingView.widget({
                        ...
                        locale: that.lang =='English'?'en':"zh",
                        debug: false,
