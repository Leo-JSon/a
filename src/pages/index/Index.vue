            ...
            <div class="section" id="page5">
                <div class="mainPage5">
                    ...
                    <div class="page5Right">
                        ...
                        <ul>
                            <li>
                                <a @click="donwload(0)"><img src="../../assets/img/iphone.png" alt=""><span>{{$t("description.iphone")}}</span></a>
                            </li>
                            <li>
                                <a @click="donwload(1)"><img src="../../assets/img/andriod.png" alt=""><span>{{$t("description.andriod")}}</span> </a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                columns: [
                    {
                        ...
                        render: function(h, params) {
                            ...
                            if (params.row.coin == 'BTC') {
                             ...
                             } else if (params.row.coin == 'DBD') {
                                return h('div', [
                                    h('img', {
                                        attrs: {
                                        src:require('../../assets/images/dbd.png')
                                        },
                                    } ),
                                    h('span', {}, params.row.coin),
                                ])
                             } else if (params.row.coin == 'BTM') {
                                return h('div', [
                                    h('img', {
                                        attrs: {
                                        src:require('../../assets/images/BTM.png')
                                        },
                                    } ),
                                    h('span', {}, params.row.coin),
                                ])
                             } else if (params.row.coin == 'ETC') {
                                return h('div', [
                                    h('img', {
                                        attrs: {
                                        src:require('../../assets/images/ETC.png')
                                        },
                                    } ),
                                    h('span', {}, params.row.coin),
                                ])
                              } else if (params.row.coin == 'DASH') {
                                return h('div', [
                                    h('img', {
                                        attrs: {
...
.page2nav ul.brclearfix li{
    flex:1;
}
.page2nav ul.brclearfix li span{
    display: block;
    width:100%;
}
#page2 {
...
.page2nav li.ivu-btn,.page2nav li.ivu-btn-ghost:hover{
    background: #D58C2A;
    color: #fff;
}
