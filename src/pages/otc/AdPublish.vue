                ...
                <div class="send-box">
                    <div class="title-box">
                        ...
                        <p>{{$t('otc.publishad.msg1')}}
                            <router-link to="/otc/trade/btc">{{$t('otc.publishad.tradead')}}</router-link>
                            。
                        </p>
                    ...
                    <div class="formbox send-form">
                        <Form ref="form" :model="form" :rules="ruleValidate" :label-width="90">
                            ...
                            <FormItem :label="$t('otc.publishad.country')" prop="country" > 
                                ...
                                <!-- <Select v-model="form.country" @on-change="onAreaChange" v-if='showCountry'>
                                    <Option v-for="area in areas"  :value="area.zhName" :key="area.zhName">{{area.zhName}}</Option>
                                 
                                </Select>
                                 <Select v-model="form.country" @on-change="onAreaChange" v-else >
                                    <Option v-for="area in areas"   :value="area.zhName" :key="area.zhName">{{area.enName}}</Option>
                                </Select> -->
                            </FormItem>
                            <!-- 1 -->
