<template>
    <div class="content-wrap">
        <div class="container chat-in-box" id="List">
            ...
            <Row class="chat-in">
                <Col span="4" style='background-color:'>
...
export default {
    ...
    methods: {
        ...
        getReserveTime:function () {
            ...
            var reserveSeconds = parseInt(this.msg.timeLimit)*60 - throughSeconds - 60;
...
.chat-in-box .ivu-btn-primary{
    background-color:#37F081;
    border-color:#37F081;
    color:#fff;
}
.chat-in-box .ivu-btn-error{
