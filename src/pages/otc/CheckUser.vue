<template>
<div class="content-wrap" id="List" style='min-height:700px;'>
    <div class="container">
        <Row>
            <Col span="4">
...
export default {
    ...
    created() {
        this.getAdv()
        console.log(this.$t('otc.tradeInfo.chat3'))
        ...
        tableColumnsOrderSell() {
            ...
            columns.push({
                ...
                render:function(h,params){
                    let text='';
                    // console.log(params.row.payMode)
                    if(params.row.payMode=='银联'){
                        text = self.$t('otc.tradeinfo.chat3')
                    }else if(params.row.payMode=='微信'){
                        text =  self.$t('otc.tradeinfo.chat2')
                    }else if(params.row.payMode=='支付宝'){
                        text =  self.$t('otc.tradeinfo.chat1')
                    }else if(params.row.payMode=='支付宝,微信,银联'){
                        text =  self.$t('otc.tradeinfo.chat1')+','+ self.$t('otc.tradeinfo.chat2')+','+ self.$t('otc.tradeinfo.chat3')
                    }else if(params.row.payMode=='支付宝,微信'){
                        text = self.$t('otc.tradeinfo.chat1')+','+self.$t('otc.tradeinfo.chat2')
                  
                    }else if(params.row.payMode=='支付宝,银联'){
                        text = self.$t('otc.tradeinfo.chat1')+','+self.$t('otc.tradeinfo.chat3')
                    }else if(params.row.payMode=='微信,银联'){
                        text = self.$t('otc.tradeinfo.chat2')+','+self.$t('otc.tradeinfo.chat3')
                    }
                    ...
                    return h('p', [
                        h('a', {
                            on: {
                                click: function() {
                                    if (!self.isLogin) {
                                        self.$Message.error(self.$t('common.logintip'));
