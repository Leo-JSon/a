<template>
<div style="padding: 81px;padding-top: 20px;">
    <div class="content">
        <!---->
        ...
        <div style="width: 80%;margin: 0 auto;margin-bottom: 60px;">
            ...
            <div v-if="certStatus == 6" style="width: 500px;margin: 0 auto;text-align: center;">
                <Button type="info" style="width: 120px;background:#313654;border-color:#313654;color:#fff;" @click="modal_return=true" long size="large">{{$t('otc.identBusiness.step5')}}</Button>
            ...
            <div v-if="certStatus == 7" style="width: 500px;margin: 0 auto;text-align: center;">
                <Button type="info" style="width: 120px;background:#313654;border-color:#313654;color:#fff;" @click="modal_read=true" long size="large">{{$t('otc.identBusiness.step6')}}</Button>
            </div>

            <div v-if="certStatus == 3" style="width: 500px;margin: 0 auto;text-align: center;">
                <Button type="info" style="width: 120px;background:#313654;border-color:#313654;color:#fff;" @click="modal_read=true" long size="large">{{$t('otc.identBusiness.step5')}}</Button>
                <div class="fail-reason" style="margin-top: 50px;font-size: 16px;">
            ...
            <div v-else-if="certStatus == 2" style="width: 500px;margin: 0 auto;text-align: center;">
                <Button type="info" style="width: 120px;background:#313654;border-color:#313654;color:#fff;" @click="publishAd" long size="large">{{$t('otc.identBusiness.advpush')}}</Button>
    ...
    <Modal v-model="modal_read">
        ...
        <div class="apply-note">
            ...
            <div style="text-align: left;padding: 30px 0;">
                <Checkbox v-model="agreeFrozen"></Checkbox> <span>{{$t('otc.identBusiness.operate18')}}<font color="#D58C2A">{{auditText}}</font>{{$t('otc.identBusiness.operate19')}}</span>
            </div>
        ...
        <div class="apply-content">
            ...
            <Form class="apply-form" :model="apply_form" label-position="top">
                ...
                <FormItem style="margin-top: 20px;">
                    <Button style="width:100%;" class='whiteColor' type="info" @click="apply3('apply_form')" :disabled="applyBtn">{{$t('otc.identBusiness.step8')}}</Button>
                </FormItem>
            </Form>
        </div>
        <p slot="footer"></p>
...
export default {
    ...
    assetHandleSuccess(res,file){
        this.apply_form.assetData =this.assetHandImg= res.data;
        this.isAssetHandImg=true;
    },
    tradeHandleSuccess(res,file){
        this.apply_form.tradeData =this.tradeHandImg= res.data;
...
<style>
  ...
  .whiteColor.ivu-btn-info,.whiteColor.ivu-btn-info:hover{
      color:#fff;
  }
</style>
